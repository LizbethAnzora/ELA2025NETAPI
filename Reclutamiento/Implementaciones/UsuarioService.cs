...
public class UsuarioService : IUsuarioService
{
    ...
    public async Task<IEnumerable<UsuarioDTO>> GetAdminsAsync()
    {
        ...
        return admins.Where(u => u.Rol == Rol.Admin)
                     .Select(u => new UsuarioDTO { Id = u.Id, CorreoElectronico = u.CorreoElectronico, NombreCompleto = u.NombreCompleto, Rol = u.Rol.ToString() });
    }
    ...
    public async Task<UsuarioDTO> GetAdminByIdAsync(int id)
    {
        ...
        return new UsuarioDTO { Id = user.Id, CorreoElectronico = user.CorreoElectronico, NombreCompleto = user.NombreCompleto, Rol = user.Rol.ToString() };
    }
